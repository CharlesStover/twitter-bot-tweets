...
module.exports = {
  ...
  'Boost Your Page Speed: Reduce Parse Time': {
    status: `Improve your page load speed by allowing the browser to parse and display it faster. ${medium}boost-your-page-speed-reduce-parse-time-d2a380907de5 ${hashtags(null, 'frontend')}}`,
  },
  'Boost Your Page Speed: Reduce Server Calls': {
    status: `Improve your page load speed by decreasing unnecessary server calls. ${medium}boost-your-page-speed-reduce-server-calls-6b7384d38cb ${hashtags(null, 'frontend')}`,
  },
  'Cache your React event listeners to improve performance': {
    status: `A deep-dive into the performance benefits of memoizing #ReactJS props. ${medium}cache-your-react-event-listeners-to-improve-performance-14f635a62e15 ${hashtags('ReactJS', 'frontend', 'js', 'react', 'reactnative', 'typescript')}`,
  },
  'The Fetch API and asynchronous Redux state': {
    status: `Understand the states of an API call and their relationship to a #Redux store ${medium}the-fetch-api-and-asynchronous-redux-state-203270a540d4 ${hashtags('Redux', 'frontend', 'react', 'reactnative', 'redux', 'typescript')}`,
  },
  'Fixing React Native WebView’s postMessage for iOS': {
    status: `A #JavaScript-only solution to Expo’s postMessage problem on #iOS. ${medium}fixing-react-native-webviews-postmessage-for-ios-10e2320b2f14 ${hashtags('JavaScript', 'react', 'reactnative')}`,
  },
  ...
  'How to convert withRouter to a React Hook': {
    status: `Converting react-router’s withRouter HOC to a #ReactJS Hook: A Tutorial ${medium}how-to-convert-withrouter-to-a-react-hook-19bb02a29ed6 ${hashtags('ReactJS', 'frontend', 'react', 'reactnative', 'typescript')}`,
  },
  'Implementing Quicksort in JavaScript': {
    status: `How to implement the Quicksort algorithm in #JavaScript ${medium}implementing-quicksort-in-javascript-8044a8e2bf39 ${hashtags('JavaScript', 'frontend', 'js', 'typescript')}`,
  },
  ...
  'Optimal file structure for React applications': {
    status: `The #ReactJS community still struggles with file structure. It’s a lot of work to refactor, so I’ve published some tips I’ve learned along the way. ${medium}optimal-file-structure-for-react-applications-f3e35ad0a145 ${hashtags('ReactJS', 'frontend', 'react')}`,
  },
  'React Suspense with the Fetch API': {
    status: `When Dan Abramov tells you Suspense is incompatible with a Fetch API #ReactJS Hook, prove him wrong ${medium}react-suspense-with-the-fetch-api-a1b7369b0469 ${hashtags('ReactJS', 'frontend', 'react', 'reactnative')}`,
  },
  'Replacing Redux with ReactN to reduce complexity and bundle size': {
    status: `I convert a bare-bones #ReactJS/#Redux application to ReactN to showcase simpler code and a 15% reduction in bundle size. ${medium}replacing-redux-with-reactn-to-reduce-complexity-and-bundle-size-aa7009cd1209 ${hashtags([ 'ReactJS', 'Redux' ], 'frontend' ,'react', 'redux')}`,
  },
  'Variable length currying in JavaScript': {
    status: `How to write a curried function in #JavaScript that can take any number of parameters. ${medium}variable-length-currying-in-javascript-7f7bb7bdad8b ${hashtags('JavaScript', 'frontend', 'js')}`,
  },

  // NPM packages
  '@charlesstover/hsl2rgb': {
    status: `Work with colors? Simplify your code base by using hsl2rgb to easily convert HSL to RGB values. ${github}hsl2rgb-js ${hashtags(null, 'frontend', 'js')}`,
  },
  '@charlesstover/quicksort': {
    status: `You can sort your arrays using Quicksort in #JavaScript. ${github}quicksort-js ${hashtags('JavaScript', 'frontend', 'js', 'typescript')}`,
  },
  'deep-proxy-polyfill': {
    status: `Deeply nest #JavaScript Proxy’s get and set property listeners, even in browsers that don’t support Proxies! ${github}deep-proxy-polyfill ${hashtags('JavaScript', 'frontend', 'js', 'typescript')}`
  },
  delimiter: {
    status: `Do you give a fRiCk about an #OxfordComma? You can automatically delimit your arrays with the delimiter NPM package. ${github}delimiter ${hashtags(null, 'frontend', 'js')}`,
  },
  'fetch-action-creator': {
    status: `fetch-action-creator reduces boilerplate and errors by automating the process of writing #Redux actions for Fetch API requests. ${github}fetch-action-creator ${hashtags('Redux', 'frontend', 'react', 'redux', 'typescript')}`,
  },
  'fetch-suspense': {
    status: `fetch-suspense is a #ReactJS hook that supports the Suspense Component! ${github}fetch-suspense ${hashtags('ReactJS', 'frontend', 'react', 'typescript')}`,
  },
  konami: {
    status: `↑↑↓↓←→←→🅱🅰, now as a #JavaScript event listener https://github.com/GamingMedley/konami.js ${hashtags('JavaScript', 'js')}`,
  },
  'mssql-query-builder': {
  ...
  'react-innertext': {
    status: `The react-innertext package lets you access the innerText of #ReactJS components as if they were DOM nodes. ${github}react-innertext ${hashtags('ReactJS', 'frontend', 'react')}`,
  },
  'react-mui-tooltip': {
    status: `Use #MaterialDesign tooltips to enhance the #UIUX your #ReactJS application. ${github}react-mui-tooltip ${hashtags([ 'MaterialDesign', 'ReactJS', 'UIUX' ], 'frontend', 'materialdesign', 'react', 'uiux')}`,
  },
  'react-multi-context': {
    status: `Simplify #ReactJS’s Context API by managing multiple contexts with a single component. ${github}react-multi-context ${hashtags('ReactJS', 'frontend', 'react')}`,
  },
  'react-object-prop': {
  ...
  'Spritesheet to GIF Converter': {
    status: 'Convert a sprite sheet to an animated GIF with the click of a button. https://charlesstover.com/spritesheet2gif #GIFs',
  },
